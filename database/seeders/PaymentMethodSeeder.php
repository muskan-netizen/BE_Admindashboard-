...
class PaymentMethodSeeder extends Seeder
{
    ...
    public function run(){
      ...
      $payment_options = array(
            ...
            array('id' => '8','name' => __('Vodafone'),'image' => 'vodafone.png','slug' => 'vodafone', 'is_show' => '1'),
            array('id' => '9','name' => __('Airteltigo'),'image' => 'airteltigo.png','slug' => 'airteltigo', 'is_show' => '1'),
            array('id' => '10','name' => __('MTN Mobile Money'),'image' => 'mtn-mobile.png','slug' => 'mtn-mobile', 'is_show' => '1'),
          );
