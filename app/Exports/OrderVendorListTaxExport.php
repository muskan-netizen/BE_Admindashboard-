    ...
    public function map($order_vendors): array
    {
        if(Auth::user()->is_superadmin)
        {
            return [
                ...
                number_format($order_vendors->payable_amount??0,2) - (number_format($order_vendors->admin_commission_percentage_amount??0,2) + number_format($order_vendors->admin_commission_fixed_amount??0,2) + number_format($order_vendors->delivery_fee??0,2)),
                ...
                $order_vendors->orderDetail ? ($order_vendors->orderDetail->address ? $order_vendors->orderDetail->address->house_number??''.', '.$order_vendors->orderDetail->address->address.', '.$order_vendors->orderDetail->address->city.', '.$order_vendors->orderDetail->address->state : '') : '',
