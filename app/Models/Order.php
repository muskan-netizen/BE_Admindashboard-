...
class Order extends Model implements Auditable
{
    ...
    protected $fillable = ['total_delivery_fee', 'total_waiting_price', 'total_waiting_time', 'recurring_booking_type', 'recurring_week_day', 'recurring_week_type', 'recurring_day_data', 'recurring_booking_time', 'scheduled_date_time', 'marg_max_attempt', 'marg_status', 'rental_hours', 'total_amount', 'attachment_path', 'driver_share_otp'];
