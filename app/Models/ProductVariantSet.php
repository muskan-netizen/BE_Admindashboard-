...
class ProductVariantSet extends Model
{
	...
	public function option2() {
	    return $this->hasMany('App\Models\ProductVariantSet', 'variant_type_id', 'variant_type_id')
    		...
    		->select('pvs.hexacode', 'vt.title', 'product_variant_sets.product_id', 'product_variant_sets.variant_type_id', 'product_variant_sets.variant_option_id', 'product_variant_sets.product_variant_id','pv.quantity')
