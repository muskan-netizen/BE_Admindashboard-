...
class ClientPreference extends Model
{
    ...
    public function client_preference_new()
    {
      return $this->hasOne('App\Models\ClientPreferenceNew','client_code','client_code');
    }
