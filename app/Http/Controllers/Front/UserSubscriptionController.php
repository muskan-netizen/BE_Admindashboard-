...
class UserSubscriptionController extends FrontController
{
    ...
    public function selectSubscriptionPlan(Request $request, $domain = '', $slug = '')
    {
        ...
        $code = array('stripe', 'stripe_fpx', 'yoco', 'paylink', 'razorpay','simplify','square','ozow','pagarme', 'checkout','authorize_net','kongapay','ccavenue', 'cashfree','viva_wallet','easebuzz','vnpay','paytab','mvodafone','flutterwave','easypaisa','braintree','payphone','windcave','paytech');
        $ex_codes = array('cod');
