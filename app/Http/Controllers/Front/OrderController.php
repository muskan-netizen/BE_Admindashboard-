...
class OrderController extends FrontController
{
    ...
    public function orders(Request $request, $domain = '')
    {
      ...
      //  pr($activeOrders->toArray());exit();
        ...
        return view('frontend.account.orders')->with(['payments' => $payments, 'rejectedOrders' => $rejectedOrders, 'navCategories' => $navCategories, 'activeOrders' => $activeOrders, 'pastOrders' => $pastOrders, 'returnOrders' => $returnOrders, 'clientCurrency' => $clientCurrency, 'clientPreference' => $client_preferences, 'fixedFee'=>$fixedFee,'longTermOrder'=>$longTermOrder, 'cancellation_reason' => $cancellation_reason]);
