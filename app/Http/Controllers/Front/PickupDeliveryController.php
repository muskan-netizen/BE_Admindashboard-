...
class PickupDeliveryController extends FrontController
{
    ...
    public function postCabProductById(Request $request, $domain = '', $product_id = 0)
    {
        ...
        $product = Product::with([
            'taxCategory', 'category.categoryDetail', 'media.image', 'vendor', 'tollpass', 'travelmode', 'emissiontype', 'translation' => function ($q) use ($language_id) {
    ...
    public function productsByVendorInPickupDelivery(Request $request, $domain = '', $vid = 0, $cid = 0)
    {
        try {
            ...
            $products = Product::with([
                'category.categoryDetail', 'tollpass', 'travelmode', 'emissiontype', 'inwishlist' => function ($qry) use ($userid) {
        ...
        try {
            ...
            if ($dispatch_domain && $dispatch_domain != false) {
                ...
                if ($is_rental) {
                    ...
                    $res = $client->post(
                        $url . '/api/get-delivery-fee-rental',
