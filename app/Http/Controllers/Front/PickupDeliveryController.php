...
class PickupDeliveryController extends FrontController{
    ...
    {
        $code = array('cod', 'dpo', 'razorpay','stripe','paystack', 'payfast','authorize_net','payphone', 'khalti','flutterwave'); 
    ...
    public function postCabProductById(Request $request, $domain = '',$product_id = 0){
        ...
        $product = Product::with(['category.categoryDetail','media.image', 'tollpass', 'travelmode', 'emissiontype', 'translation' => function($q) use($language_id){
