                    ...
                    if(isset($prod->product) && !empty($prod->product)){
                      //  pr($prod->product);
                        ...
                        if ($prod->pvariant) {
                            ...
                            // if($prod->product->)
                            $prod->rentalProtection = $prod->product->rentalProtection;
