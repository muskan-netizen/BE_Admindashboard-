...
class HomeController extends BaseController
{
    ...
    public function headerContent(Request $request)
    {
        try {
            ...
            $getAdditionalPreference = getAdditionalPreference(['advance_booking_amount', 'advance_booking_amount_percentage','update_order_product_price','is_one_push_book_enable']);
