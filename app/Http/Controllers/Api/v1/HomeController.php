...
class HomeController extends BaseController
{
    ...
    public function headerContent(Request $request)
    {
        try {
            ...
            $homeData['profile'] = Client::with(['preferences', 'country:id,name,code,phonecode'])->select('id','country_id', 'company_name', 'code', 'sub_domain','sub_domain','database_name', 'logo', 'company_address', 'phone_number', 'email','custom_domain','contact_phone_number','socket_url')->first();
