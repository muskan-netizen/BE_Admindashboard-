...
class UserSubscriptionController extends BaseController
{
    ...
    public function selectSubscriptionPlan(Request $request, $slug = '')
    {
        try{
            ...
            $code = array('stripe', 'stripe_fpx','azul', 'dpo', 'paystack', 'payfast', 'yoco', 'paylink', 'checkout','kongapay','ccavenue', 'cashfree','easebuzz','vnpay','paytab','toyyibpay','flutterwave','mvodafone','windcave','payphone','stripe_oxxo','viva_wallet', 'mycash','stripe_ideal','openpay','userede','khalti','plugnpay','razorpay');
            $ex_codes = array('cod');
