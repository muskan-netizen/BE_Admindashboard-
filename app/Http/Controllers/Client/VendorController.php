...
class VendorController extends BaseController
{
    ...
    public function vendorCatalog($domain = '', $id){
        ...
        $isHyperlocal = ClientPreference::value('is_hyperlocal');
