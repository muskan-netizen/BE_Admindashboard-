...
class ClientPreferenceController extends BaseController{
    ...
    use ApiResponser;
    use ValidatorTrait;
    public $client_preference_fillable_key = ['hubspot_access_token', 'is_hubspot_enable', 'gtag_id', 'fpixel_id','is_price_by_role'];
