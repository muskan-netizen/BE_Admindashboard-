   ...
   // enable/disable price key in Role table (START)
    ...
    public function vendorMargConfigUpdate($domain,Request $request,$vendor_id)
    {
        VendorMargConfig::updateOrCreate([
            ...
            'marg_date_time' => $request->marg_date_time??null
        ]);
