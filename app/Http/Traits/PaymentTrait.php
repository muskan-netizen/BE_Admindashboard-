...
trait PaymentTrait{
    ...
    function paymentOptionArray($type='')
    {
        ...
        {
            $paymentOptions = ['cod','azul', 'dpo', 'razorpay','paystack','stripe','payfast','offline_manual','authorize_net','payphone','khalti','flutterwave','plugnpay','nmi','yappy','skip_cash','ccavenue','powertrans'];
