...
trait Mpesa{
   ...
   {
        // $mpesa = PaymentOption::select('credentials', 'test_mode','status')->where('code', 'mpesa')->where('status', 1)->first();
        ...
        $this->CallBackURL = "https://webhook.site/04c6d8b2-0fce-4083-9a92-aab85b77efdf"; //Your callback URL
        $this->env = "sandbox"; //Your Environment sandbox or Live
        // $this->env = (($mpesa->test_mode==1)?"sandbox":"Live"); //Your Environment sandbox or Live
        $this->initiatorName = "testmpesa"; //Username of your choice
        $this->initiatorPassword = "royompesa"; //Password of your choice
   }

    public function credentials()
    {
        // $mpesa = PaymentOption::select('credentials', 'test_mode','status')->where('code', 'viva_wallet')->where('status', 1)->first();
        // $json = json_decode($mpesa->credentials);
        $this->short_code = '174379';
        $this->parent_short_code='174379';
        $this->consumer_key="u9zuYcOsETn3NOMHXvCkRk6MHQ87EK7e"; //Your Consumer key
        $this->consumer_secret="f7Vwqi0P4U66cGHY="; //"Your Secret key
        $this->passkey = "bfb279f9aa9bdbcf158e97dd71a467cd2e0c893059b10f78e6b72ada1ed2c919"; //Your Passkey  A7pnv5I1cu1c6n9qTZEkKIklGZui
        $this->CallBackURL = "https://webhook.site/04c6d8b2-0fce-4083-9a92-aab85b77efdf"; //Your callback URL
        $this->env = (($mpesa->test_mode==1)?"sandbox":"Live"); //Your Environment sandbox or Live
        $this->initiatorName = "testmpesa"; //Username of your choice
        $this->initiatorPassword = "royompesa"; //Password of your choice
