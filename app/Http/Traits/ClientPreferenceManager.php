...
trait ClientPreferenceManager{ 
  ...
  public $client_preference_fillable_key = ['is_phone_signup', 'token_currency', 'is_token_currency_enable', 'hubspot_access_token', 'is_hubspot_enable', 'gtag_id', 'fpixel_id','is_long_term_service', 'is_place_order_delivery_zero'];
  # get last mile teams
