        ...
        foreach ($databases as $client) {
            ...
            if ($db) {
                ...
                foreach ($selected_database_orders as $order_key => $order_value) {
                    ...
                    $vendor_order_status_check = VendorOrderStatus::where('order_id',$orderVendorDetail->order_id)->where('vendor_id', $orderVendorDetail->vendor_id)->where('order_status_option_id', 3)->first();
