...
window.initializeSlider = function initializeSlider() {
    ...
    $(".brand-slider").slick({arrows:!0,dots:!1,infinite:!0,speed:300,slidesToShow:4,slidesToScroll:3,responsive:[{breakpoint:1367,settings:{slidesToScroll:2,infinite:!0}},{breakpoint:991,settings:{slidesToScroll:2}},{breakpoint:767,settings:{slidesToScroll:1}}]});
