...
return [
    ...
    |------------------------------------------
    */
    'consumer_key'   => 'O7xnTbGuvnLP6qARXZ74W2cyJWQALbp2',

    /*-----------------------------------------
    |The App consumer Secret
    |------------------------------------------
    */
    'consumer_secret' => 'CBeBLWEs9u6yRYly',
    ...
    */
    ...
    |------------------------------------------
    */
    'initiator_username' => 'lmukhuyu',

    /*-----------------------------------------
    |Initiator Password
    |------------------------------------------
    */
    'initiator_password' => 'Zallu3279@',
    ...
    */
    ...
    |------------------------------------------
    */
    'lnmocallback' => 'https://webhook.site/6f12a228-fc95-4241-8495-1ff5f41cf421',
