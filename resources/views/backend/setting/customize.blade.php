                      ...
                      <div class="row mb-2 mx-0 flex-nowrap d-flex align-items-center">
                            ...
                            <div class="col-sm-2">
                                <div class="form-group mb-0">
                                    ...
                                    <input type="text" name="p2p_id[]" class="form-control al_box_height" value="{{ App\Models\NomenclatureTranslation::getNameBylanguageId($client_language->langId, App\Models\Nomenclature::getIdByName('P2P'))}}">
                                    @if($k == 0)
                      ...
                      <div class="row mb-2 mx-0 flex-nowrap d-flex align-items-center">
                            ...
                            <div class="col-sm-2">
                                <div class="form-group mb-0">
                                    ...
                                    <input type="text" name=pickup_id[]" class="form-control al_box_height" value="{{ App\Models\NomenclatureTranslation::getNameBylanguageId($client_language->langId, App\Models\Nomenclature::getIdByName('Where can we pick you up?'))}}">
                                    @if($k == 0)
