...
<!-- New Customize Page -->
@php
$getAdditionalPreference = getAdditionalPreference(['is_phone_signup', 'gtag_id','fpixel_id','is_token_currency_enable', 'token_currency', 'advance_booking_amount', 'advance_booking_amount_percentage','is_price_by_role']); //,'seller_sold_title','saller_platform_logo'
@endphp
   <!--Localization start -->
    <div class="row">
      <div class="col-12">
