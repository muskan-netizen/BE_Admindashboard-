                        ...
                        <div class="row mb-0">
                            ...
                            <div class="row sms_fields mx-0" id="mTalkz_fields"
                                ...
                                <div class="col-12">
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="text" name="mtalkz_sender_id" id="mtalkz_sender_id"
                                            placeholder="" class="form-control"
                            ...
                            <div class="row sms_fields mx-0" id="mazinhost_fields"
                                ...
                                <div class="col-12">
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="text" name="mazinhost_api_key" id="mazinhost_api_key"
                                            placeholder="" class="form-control"
                            ...
                            <div class="row sms_fields mx-0" id="unifonic_fields"
                                ...
                                <div class="col-12">
                                    <div class="form-group mb-2">
                                        <label
                                            for="unifonic_account_password">{{ __('Unifonic Account Password') }}</label>
                                        <input type="text" name="unifonic_account_password"
                                            id="unifonic_account_password" placeholder="" class="form-control"
                            ...
                            <div class="row sms_fields mx-0" id="arkesel_fields"
                                ...
                                <div class="col-12">
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="text" name="arkesel_sender_id" id="arkesel_sender_id"
                                            placeholder="" class="form-control"
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-2">
                                    ...
                                    <input type="text" name="mail_type" id="mail_type" placeholder="SMTP"
                                        class="form-control"
                                        value="{{ old('mail_type', $preference->mail_type ?? '') }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-2">
                                    ...
                                    <input type="text" name="mail_host" id="mail_host" placeholder="SMTP"
                                        class="form-control"
                                        value="{{ old('mail_host', $preference->mail_host ?? '') }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-2">
                                    ...
                                    <input type="text" name="mail_port" id="mail_port" placeholder=""
                                        class="form-control"
                                        value="{{ old('mail_port', $preference->mail_port ?? '') }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-2">
                                    ...
                                    <input type="text" name="mail_from" id="mail_from" placeholder="service@xyz.com"
                                        class="form-control"
                                        value="{{ old('mail_from', $preference->mail_from ?? '') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-2">
                                    ...
                                    <input type="text" name="fcm_auth_domain" id="fcm_auth_domain" placeholder=""
                                        class="form-control"
                                        value="{{ old('fcm_auth_domain', $preference->fcm_auth_domain ?? '') }}"
                                        required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-2">
                                    ...
                                    <input type="text" name="fcm_storage_bucket" id="fcm_storage_bucket"
                                        placeholder="" class="form-control"
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-2">
                                    ...
                                    <input type="text" name="fcm_app_id" id="fcm_app_id" placeholder=""
                                        class="form-control"
                                        value="{{ old('fcm_app_id', $preference->fcm_app_id ?? '') }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-2">
                                    ...
                                    <input type="text" name="fcm_measurement_id" id="fcm_measurement_id"
                                        placeholder="" class="form-control"
                            ...
                            <div class="card-box h-100">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="form-group mt-3 mb-0">
                                            <label
                                                for="customer_support_application_id">{{ __('Application ID') }}</label>
                                            <input type="text" name="customer_support_application_id"
                                                id="customer_support_application_id"
                                                placeholder="{{ __('Please enter application ID') }}"
                                                class="form-control"
   ...
   <button class="btn btn-info d-block show-custom-mods-btn" type="submit"> {{ __("Show Custom Mods") }} </button>
        ...
        <div class="col-md-12">
            ...
            <span> <input type="checkbox" data-plugin="switchery" name="off_scheduling_at_cart" id="off_scheduling_at_cart" class="form-control" data-color="#43bee1" @if (isset($preference) && $preference->off_scheduling_at_cart == '1') checked='checked' @endif>
                            ...
                            <div class="col-md-4">
                                <div class="form-group d-flex justify-content-between mb-3 alCustomToggleColor">
                                    <label for="isolate_single_vendor_order"
                                        class="mr-2 mb-0">{{ __('Isolate Single Vendor Order') }} <small
                                            class="d-block pr-5">{{ __('Only allow customers to place order from one vendor at a time.') }}</small></label>
                                    <span> <input type="checkbox" data-plugin="switchery"
                                            name="isolate_single_vendor_order" id="isolate_single_vendor_order"
                                            class="form-control" data-color="#43bee1"
                            ...
                            <div class="col-md-4">
                                <div class="form-group d-flex justify-content-between mb-3 alCustomToggleColor">
                                    <label for="subscription_mode"
                                        class="mr-2 mb-0">{{ __('Subscription Mod') }}<small
                                            class="d-block pr-5">{{ __('Enable the option to create Subscriptions for Customers and Vendors.') }}</small></label>
                                    <span> <input type="checkbox" data-plugin="switchery" name="subscription_mode"
                                            id="subscription_mode" class="form-control" data-color="#43bee1"
                        ...
                        <div class="col-md-4">
                            <div class="form-group d-flex justify-content-between mb-3 alCustomToggleColor">
                                <label for="subscription_tab_taxi"
                                    class="mr-2 mb-0">{{ __('Subscription Tab') }}<small
                                        class="d-block pr-5">{{ __('Enable subscription tab for taxi/cab.') }}</small></label>
                                <span> <input type="checkbox" data-plugin="switchery" name="subscription_tab_taxi"
                                        id="subscription_tab_taxi" class="form-control" data-color="#43bee1"
                                        @if (isset($preference) && $preference->subscription_tab_taxi == '1') checked='checked' @endif>
                                </span>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group d-flex justify-content-between mb-3 alCustomToggleColor">
                                ...
                                <span> <input type="checkbox" data-plugin="switchery" name="tip_before_order"
                                        id="tip_before_order" class="form-control" data-color="#43bee1"
                                        @if (isset($preference) && $preference->tip_before_order == '1') checked='checked' @endif>
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group d-flex justify-content-between mb-3 alCustomToggleColor">
                                ...
                                <span> <input type="checkbox" data-plugin="switchery" name="tip_after_order"
                                        id="tip_after_order" class="form-control" data-color="#43bee1"
                                        @if (isset($preference) && $preference->tip_after_order == '1') checked='checked' @endif>
                                </span>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group d-flex justify-content-between mb-3 alCustomToggleColor">
                                <label for="auto_implement_5_percent_tip"
                                    class="mr-2 mb-0">{{ __('Auto Implement Tip 5%') }}<small
                                        class="d-block pr-5">{{ __('Enable to apply auto implement 5 percent tip.') }}</small></label>
                                <span> <input type="checkbox" data-plugin="switchery"
                                        name="auto_implement_5_percent_tip" id="auto_implement_5_percent_tip"
                                        class="form-control" data-color="#43bee1"
                        ...
                        <div class="col-md-4">
                            <div class="form-group d-flex justify-content-between mb-3 alCustomToggleColor">
                                <label for="product_order_form"
                                    class="mr-2 mb-0">{{ $nomenclatureProductOrderForm }}<small
                                        class="d-block pr-5">{{ __('Add a Product Order form. Create Dynamic questions per product.') }}</small></label>
                                <span> <input type="checkbox" data-plugin="switchery" name="product_order_form"
                                        id="product_order_form" class="form-control" data-color="#43bee1"
                                        @if (isset($preference) && $preference->product_order_form == '1') checked='checked' @endif>
                                </span>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group d-flex justify-content-between mb-3 alCustomToggleColor">
                                ...
                                <span> <input type="checkbox" data-plugin="switchery" name="gifting" id="gifting"
                                        class="form-control" data-color="#43bee1"
                                        @if (isset($preference) && $preference->gifting == '1') checked='checked' @endif>
                                </span>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group d-flex justify-content-between mb-3 alCustomToggleColor">
                                <label for="pickup_delivery_service_area"
                                    class="mr-2 mb-0">{{ __('Pickup Delivery Service Area') }}<small
                                ...
                                <span> <input type="checkbox" data-plugin="switchery"
                                        name="pickup_delivery_service_area" id="pickup_delivery_service_area"
                                        class="form-control" data-color="#43bee1"
                            ...
                            @if ($client_preference_detail->business_type == 'laundry')
                                <div class="col-md-4">
                                    <div class="form-group d-flex justify-content-between mb-3 alCustomToggleColor">
                                        <label for="get_estimations"
                                            class="mr-2 mb-0">{{ __('Get Estimations') }}<small
                                        ...
                                        <span> <input type="checkbox" data-plugin="switchery" name="get_estimations"
                                                id="get_estimations" class="form-control" data-color="#43bee1"
                                ...
                                <div class="col-md-4" @if ($client_preference_detail->get_estimations == 0) style="display:none;" @endif
                                    ...
                                    <div class="form-group d-flex justify-content-between mb-3 alCustomToggleColor">
                                        ...
                                        <span> <input type="checkbox" data-plugin="switchery"
                                                name="view_get_estimation_in_category"
                                                id="view_get_estimation_in_category" class="form-control"
                                                data-color="#43bee1"
                      ...
                      <div class="form-group d-flex justify-content-between mb-3 alCustomToggleColor">
                        ...
                        <span> <input type="checkbox" data-plugin="switchery" name="enable_inventory_service" id="enable_inventory_service" class="form-control" data-color="#43bee1" @if (isset($preference) && $preference->enable_inventory_service == '1') checked='checked' @endif>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group d-flex justify-content-between mb-3 alCustomToggleColor">
                                        <label for="book_for_friend"
                                            class="mr-2 mb-0">{{ __('Book for a Friend') }}<small
                                                class="d-block pr-5">{{ __('Enable to add book for a friend functionality for customers.') }}</small></label>
                                        <span> <input type="checkbox" data-plugin="switchery" name="book_for_friend"
                                                id="book_for_friend" class="form-control" data-color="#43bee1"
                            ...
                            @if ($client_preference_detail->business_type == 'laundry')
                                <div class="col-md-4">
                                    <div class="form-group d-flex justify-content-between mb-3 alCustomToggleColor">
                                        <label for="is_scan_qrcode_bag"
                                            class="mr-2 mb-0">{{ __('Scan Bag QR code') }}<small
                                                class="d-block pr-5">{{ __('Enable to scan bag QR code for orders.') }}</small></label>
                                        <span> <input type="checkbox" data-plugin="switchery"
                                                name="is_scan_qrcode_bag" id="is_scan_qrcode_bag" class="form-control"
                                                data-color="#43bee1"
                            ...
                            <div class="col-md-4">
                                <div class="form-group d-flex justify-content-between mb-3 alCustomToggleColor">
                                    ...
                                    <span>
                                        <input type="checkbox" data-plugin="switchery" name="is_attribute_switch"
                                            id="is_attribute_switch" class="form-control checkbox_change"
                                            data-className="is_attribute" data-color="#43bee1"
                                            @if ($getAdditionalPreference['is_attribute'] == '1') checked='checked' @endif>
                                        <input type="hidden"
                                            @if ($getAdditionalPreference['is_attribute'] == 1) value="1" @else value="0" @endif
                            ...
                            <div class="col-md-4">
                                <div class="form-group d-flex justify-content-between mb-3 alCustomToggleColor">
                                    ...
                                    <span> <input type="checkbox" data-plugin="switchery" name="is_gift_card_switch"
                                            ...
                                            @if (@getAdditionalPreference(['is_gift_card'])['is_gift_card'] == 1) checked='checked' @endif>
                                    </span>
                                    <input type="hidden"
                                        @if (@getAdditionalPreference(['is_gift_card'])['is_gift_card'] == 1) value="1" @else value="0" @endif
                            ...
                            <div class="col-md-4">
                                <div class="form-group d-flex justify-content-between mb-3 alCustomToggleColor">
                                    ...
                                    <span> <input type="checkbox" data-plugin="switchery"
                                            ...
                                            data-color="#43bee1"
                                            @if (@getAdditionalPreference(['add_to_cart_btn'])['add_to_cart_btn'] == 1) checked='checked' @endif>
                                    </span>
                                    <input type="hidden"
                                        @if (@getAdditionalPreference(['add_to_cart_btn'])['add_to_cart_btn'] == 1) value="1" @else value="0" @endif
                            ...
                            <div class="col-md-4">
                                <div class="form-group d-flex justify-content-between mb-3 alCustomToggleColor">
                                    ...
                                    <span> <input type="checkbox" data-plugin="switchery" name="chat_button_switch"
                                            ...
                                            @if (@getAdditionalPreference(['chat_button'])['chat_button'] == 1) checked='checked' @endif>
                                    </span>
                                    <input type="hidden"
                                        @if (@getAdditionalPreference(['chat_button'])['chat_button'] == 1) value="1" @else value="0" @endif
                            ...
                            <div class="col-md-4">
                                <div class="form-group d-flex justify-content-between mb-3 alCustomToggleColor">
                                    ...
                                    <span> <input type="checkbox" data-plugin="switchery" name="call_button_switch"
                                            ...
                                            @if (@getAdditionalPreference(['call_button'])['call_button'] == 1) checked='checked' @endif>
                                    </span>
                                    <input type="hidden"
                                        @if (@getAdditionalPreference(['call_button'])['call_button'] == 1) value="1" @else value="0" @endif
                            ...
                            <div class="col-md-4">
                                <div class="form-group d-flex justify-content-between mb-3 alCustomToggleColor">
                                    ...
                                    <span> <input type="checkbox" data-plugin="switchery"
                                            ...
                                            data-color="#43bee1"
                                            @if (@getAdditionalPreference(['is_tracking_url'])['is_tracking_url'] == 1) checked='checked' @endif>
                                    </span>
                                    <input type="hidden"
                                        @if (@getAdditionalPreference(['is_tracking_url'])['is_tracking_url'] == 1) value="1" @else value="0" @endif
                            ...
                            <div class="col-md-4">
                                <div class="form-group d-flex justify-content-between mb-3 alCustomToggleColor">
                                    ...
                                    <span> <input type="checkbox" data-plugin="switchery"
                                            ...
                                            data-color="#43bee1"
                                            @if (@getAdditionalPreference(['is_tracking_sms_url'])['is_tracking_sms_url'] == 1) checked='checked' @endif>
                                    </span>
                                    <input type="hidden"
                            ...
                            <div class="col-md-4">
                                <div class="form-group d-flex justify-content-between mb-3 alCustomToggleColor">
                                   <label for="is_service_product_price_from_dispatch_switch" class="mr-2 mb-0">{{__('Service Product Price from Dispatcher')}}<small class="d-block pr-5">{{__("Enable to Send Email on Customer Successfull Signup.")}}</small></label>
                        ...
                        <div class="col-md-4">
                            <div class="form-group d-flex justify-content-between mb-3 alCustomToggleColor">
                                <label for="minimum_order_batch"
                                    class="mr-2 mb-0">{{ __('Minimum Order/Increment') }}<small class="d-block pr-5">
                                        {{ __('Set the minimum order and minimum increment per product.') }}.</small></label>
                                <span> <input type="checkbox" data-plugin="switchery" name="minimum_order_batch"
                                        id="minimum_order_batch" class="form-control" data-color="#43bee1"
                        ...
                        <div class="col-md-4">
                            <div class="form-group d-flex justify-content-between mb-3 alCustomToggleColor">
                                <label for="static_delivey_fee"
                                    class="mr-2 mb-0">{{ __('Static Delivery fee') }}<small
                                        class="d-block pr-5">{{ __('Set a static Delivery Price per vendor based on Minimum Order Value.') }}</small></label>
                                <span> <input type="checkbox" data-plugin="switchery" name="static_delivey_fee"
                                        id="static_delivey_fee" class="form-control" data-color="#43bee1"
                                ...
                                <div class="form-group d-flex justify-content-between mb-3 alCustomToggleColor">
                                    <label for="view_get_estimation_in_category"
                                        class="mr-2 mb-0">{{ __('Enable Estimation Link in Header Category') }}<small
                                            ...
                                            categories on the header.</small></label>
                                    <span> <input type="checkbox" data-plugin="switchery"
                                            name="view_get_estimation_in_category" id="view_get_estimation_in_category"
                                            class="form-control" data-color="#43bee1"
                                            @if (isset($preference) && $preference->view_get_estimation_in_category == '1') checked='checked' @endif>
                                    </span>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group d-flex justify-content-between mb-3 alCustomToggleColor">
                                ...
                                <span> <input type="checkbox" data-plugin="switchery" name="max_safety_mod"
                                        id="max_safety_mod" class="form-control" data-color="#43bee1"
                        ...
                        <div class="col-md-4">
                            <div class="form-group d-flex justify-content-between mb-3 alCustomToggleColor">
                                <label for="hide_order_address"
                                    class="mr-2 mb-0">{{ __('Hide customer details') }}<small
                                        class="d-block pr-5">{{ __('Enable to hide customer details from order.') }}</small></label>
                                <span> <input type="checkbox" data-plugin="switchery" name="hide_order_address"
                                        id="hide_order_address" class="form-control" data-color="#43bee1"
                        ...
                        <div class="col-md-4">
                            <div class="form-group d-flex justify-content-between mb-3 alCustomToggleColor">
                                <label for="category_kyc_documents"
                                    class="mr-2 mb-0">{{ __('User Place Order Documents') }}<small
                        ...
                        <div class="col-md-4">
                            <div class="form-group d-flex justify-content-between mb-3 alCustomToggleColor">
                                ...
                                <span> <input type="checkbox" data-plugin="switchery" name="third_party_accounting"
                                        id="third_party_accounting" class="form-control" data-color="#43bee1"
                        ...
                        <div class="col-md-4">
                            <div class="form-group d-flex justify-content-between mb-3 alCustomToggleColor">
                                <label for="is_cancel_order_user"
                                    class="mr-2 mb-0">{{ __('Order Cancellation By User') }}<small
                                        class="d-block pr-5">{{ __('Enable to give permission to user for cancelling order.') }}</small></label>
                                <span> <input type="checkbox" data-plugin="switchery" name="is_cancel_order_user"
                                        id="is_cancel_order_user" class="form-control" data-color="#43bee1"
                        ...
                        <div class="col-md-4">
                            <div class="form-group d-flex justify-content-between mb-3 alCustomToggleColor">
                                <label for="is_static_dropoff"
                                    class="mr-2 mb-0">{{ __('Static dropoff location') }}<small
                                        class="d-block pr-5">{{ __('Enable to add the predefined list and this will reflect in the drop-off location.') }}</small></label>
                                <span> <input type="checkbox" data-plugin="switchery" name="is_static_dropoff"
                                        id="is_static_dropoff" class="form-control" data-color="#43bee1"
                            ...
                            <div class="col-md-4">
                                <div class="form-group d-flex justify-content-between mb-3 alCustomToggleColor">
                                    <label for="is_scan_qrcode_bag"
                                        class="mr-2 mb-0">{{ __('Scan Bag QR code') }}<small
                                            class="d-block pr-5">{{ __('Enable to scan bag QR code for orders.') }}</small></label>
                                    <span> <input type="checkbox" data-plugin="switchery" name="is_scan_qrcode_bag"
                                            id="is_scan_qrcode_bag" class="form-control" data-color="#43bee1"
                                            @if (isset($preference) && $preference->is_scan_qrcode_bag == '1') checked='checked' @endif>
                                    </span>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group d-flex justify-content-between mb-3 alCustomToggleColor">
                                ...
                                <span> <input type="checkbox" data-plugin="switchery" name="is_vendor_tags"
                                        id="is_vendor_tags" class="form-control" data-color="#43bee1"
                        ...
                        <div class="col-md-4">
                            <div class="form-group d-flex justify-content-between mb-3 alCustomToggleColor">
                                ...
                                <span> <input type="checkbox" data-plugin="switchery"
                                        name="is_service_area_for_banners" id="is_service_area_for_banners"
                                        class="form-control" data-color="#43bee1"
                        ...
                        <div class="col-md-4">
                            <div class="form-group d-flex justify-content-between mb-3 alCustomToggleColor">
                                <label for="stop_order_acceptance_for_users"
                                    class="mr-2 mb-0">{{ __('Stop Order Acceptance') }}<small
                                        class="d-block pr-5">{{ __('Activate to display a busy message to customers and stop accepting orders.') }}</small></label>
                                <span> <input type="checkbox" data-plugin="switchery"
                                        name="stop_order_acceptance_for_users" id="stop_order_acceptance_for_users"
                                        class="form-control" data-color="#43bee1"
                        ...
                        <div class="col-md-4">
                            <div class="form-group d-flex justify-content-between mb-3 alCustomToggleColor">
                                <label for="map_on_search_screen"
                                    class="mr-2 mb-0">{{ __('Show map on search screen') }}<small
                                        class="d-block pr-5">{{ __("Enable to show activate vendor's in map-view on search screen.") }}</small></label>
                                <span> <input type="checkbox" data-plugin="switchery" name="map_on_search_screen"
                                        id="map_on_search_screen" class="form-control" data-color="#43bee1"
                        ...
                        <div class="col-md-4" id="slots_with_service_area_div">
                            <div class="form-group d-flex justify-content-between mb-3 alCustomToggleColor">
                                <label for="slots_with_service_area"
                                    class="mr-2 mb-0">{{ __('Food Truck Service') }}<small
                                        class="d-block pr-5">{{ __('Enable or disable multiple service area for trucks') }}</small></label>
                                <span> <input type="checkbox" data-plugin="switchery" name="slots_with_service_area"
                                        id="slots_with_service_area" class="form-control" data-color="#43bee1"
                                        @if (isset($preference) && $preference->slots_with_service_area == '1') checked='checked' @endif>
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 d-none">
                            <div class="form-group d-flex justify-content-between mb-3 alCustomToggleColor">
                                ...
                                <span> <input type="checkbox" data-plugin="switchery"
                                        name="is_long_term_service_switch" id="is_long_term_service_switch"
                                        class="form-control checkbox_change" data-className="is_long_term_service"
                                        data-color="#43bee1"
                                        @if (@getAdditionalPreference(['is_long_term_service'])['is_long_term_service'] == '1') checked='checked' @endif>
                                </span>
                                <input type="hidden"
                        ...
                        <div class="col-md-4">
                            <div class="form-group d-flex justify-content-between mb-3 alCustomToggleColor">
                                ...
                                <span> <input type="checkbox" data-plugin="switchery"
                                        name="is_influencer_refer_and_earn_switch"
                                        id="is_influencer_refer_and_earn_switch" class="form-control checkbox_change"
                                        data-className="is_influencer_refer_and_earn" data-color="#43bee1"
                                        @if (@getAdditionalPreference(['is_influencer_refer_and_earn'])['is_influencer_refer_and_earn'] == 1) checked='checked' @endif>
                                </span>
                                <input type="hidden"
                                    @if (@getAdditionalPreference(['is_influencer_refer_and_earn'])['is_influencer_refer_and_earn'] == 1) value="1" @else value="0" @endif
                        ...
                        <div class="col-md-4">
                            <div class="form-group d-flex justify-content-between mb-3 alCustomToggleColor">
                                ...
                                <span> <input type="checkbox" data-plugin="switchery" name="is_tracking_url_switch"
                                        id="is_tracking_url_switch" class="form-control checkbox_change"
                                        data-className="is_tracking_url" data-color="#43bee1"
                                        @if (@getAdditionalPreference(['is_tracking_url'])['is_tracking_url'] == 1) checked='checked' @endif>
                                </span>
                                <input type="hidden"
                                    @if (@getAdditionalPreference(['is_tracking_url'])['is_tracking_url'] == 1) value="1" @else value="0" @endif
                        ...
                        <div class="col-md-4">
                            <div class="form-group d-flex justify-content-between mb-3 alCustomToggleColor">
                                <label for="is_corporate_user_switch"
                                    class="mr-2 mb-0">{{ __(' Corporate User Enable ') }}<small
                                        class="d-block pr-5">{{ __('Enable to show corporate user type in user registration.') }}</small></label>
                                <span> <input type="checkbox" data-plugin="switchery" name="is_corporate_user_switch"
                                        id="is_corporate_user_switch" class="form-control checkbox_change"
                                        data-className="is_corporate_user" data-color="#43bee1"
                                        @if (@getAdditionalPreference(['is_corporate_user'])['is_corporate_user'] == 1) checked='checked' @endif>
                                </span>
                                <input type="hidden"
                                    @if (@getAdditionalPreference(['is_corporate_user'])['is_corporate_user'] == 1) value="1" @else value="0" @endif
                                    name="is_corporate_user" id="is_corporate_user" />
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group d-flex justify-content-between mb-3 alCustomToggleColor">
                                ...
                                <span> <input type="checkbox" data-plugin="switchery"
                                        name="is_place_order_delivery_zero_switch"
                                        ...
                                        @if (@getAdditionalPreference(['is_place_order_delivery_zero'])['is_place_order_delivery_zero'] == '1') checked='checked' @endif>
                                </span>
                                <input type="hidden"
                                    @if (@getAdditionalPreference(['is_place_order_delivery_zero'])['is_place_order_delivery_zero'] == 1) value="1" @else value="0" @endif
