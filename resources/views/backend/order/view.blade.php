                                                ...
                                                <tr>
                                                    <th scope="row" class="product-modal2">
                                                        ...
                                                        <a href={{ $product_url }}"
                                                            ...
                                                            {{ $product->product_name }} @if (@$product->product->is_long_term_service && $product->product->is_long_term_service == 1)
                                                    ...
                                                    <td>{{ $clientCurrency->currency->symbol }}{{ decimal_format($product->total_amount) }}
                                                        ...
                                                        @if (@getAdditionalPreference(['update_order_product_price'])['update_order_product_price'] == '1')
                                                            <a href="javascript:void(0);" data-toggle="modal"
                                                                ...
                                                                data-or_vend_prod_id="{{ $product->id }}">Update
                                                                Price <img src=""> </a>
                                                        @endif
                                                    </td>
                                                </tr>
                                                            ...
                                                            <div class="outer_div p-2">
                                                                ...
                                                                <table class="wp-table w-100">
                                                                    @php
                                                                        ...
                                                                        <th width="20%">#</th>
                                                                        <th width="40%">
                                                                            {{ __('Scheduled date time') }}</th>
                                                                        <th width="20%">{{ __('Service Status') }}
                                                                        </th>
                                                                        @if ($showRoute == 1)
                                                                            <th width="20%">
                                                                                {{ __('Service Route') }}</th>
