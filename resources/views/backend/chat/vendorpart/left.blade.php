				...
				<div class="messages-box flex flex-1">
					@foreach ($chatrooms as $chatroom)
						<div id="chatRooms" class=" list-group rounded-0">
							<div id="room_{{ $chatroom['_id']}}" data-id="{{$chatroom['_id']}}" data-roomID="{{$chatroom['room_id']}}" data-roomName="{{$chatroom['room_name']}}" class="chat-list-item d-flex align-items-start rounded fetchChat">
								{{-- <div class="align-self-center mr-3">
									<div class="rounded-circle bg-gray" style="width: 8px; height: 8px; opacity: 0;"></div>
								</div> --}}
								<div class="align-self-center col-md-3">
									<div class="overflow-hidden">
										<p class="orderNumber m-0 mb-2">sadasd##</p>
								...
								<div class="col-md-9 position-relative">
									<div class="alNameTime">
										<h6 class="mb-1 mt-0">{{ $chatroom['room_id'] }}</h6>
										{{-- <div class="w-100 d-flex mt-2">
											<img style="margin-right: 10px" class="rounded-circle userImg" src="images/avatar-5.jpg">
											<img class="rounded-circle userImg" src="images/avatar-5.jpg">
										</div> --}}
										{{-- <span>{{$chatroom['created_date']}}</span> --}}
										<span>4:30am, Today</span>
										<p id="preview_message_{{$chatroom['_id']}}" class="orderChatMessage mb-0">Lorem ipsum dolor sit, amet consectetur adipisicing elit. </p>
								</div>
								</div>
							</div>
						</div>		
