...
<div class="top-header  al_custom_head"> 
    ...
    <nav class="navbar navbar-expand-lg fixed-top px-0">
        ...
        <div class="col-12 d-flex align-items-center justify-content-between px-md-5 px-3">
            <!-- leftHead start -->
            <div class="leftHead d-flex align-items-center">
                ...
                <div class="logo">
                    <a class="navbar-brand position-relative" style="height:60px;" href="{{ route('userHome') }}">
                        ...
                        <!-- <img class="alspalogo lightLogo" src="images/Logolight.png">
                        <img class="alspalogo darkLogo" src="images/Logodark.png"> -->
                    </a>
                </div><!-- logo end -->
                <!-- alFindSec start -->
            ...
            <!-- rightHead start -->
            <div class="rightHead ml-auto">
                <ul class="p-0 m-0 d-flex align-items-center">
                    <!-- alUserIcon start -->
                    <li class="alUserIcon">
                        <a href="#" data-toggle="modal" data-target="#loginModal"><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M13.0151 9.27363C14.2948 8.34031 15.1282 6.82984 15.1282 5.1282C15.1282 2.30051 12.8277 0 9.99998 0C7.17228 0 4.87177 2.30051 4.87177 5.1282C4.87177 6.82984 5.70509 8.34031 6.98486 9.27363C3.80361 10.491 1.53845 13.5754 1.53845 17.1795C1.53845 18.7347 2.80373 20 4.35896 20H15.641C17.1962 20 18.4615 18.7347 18.4615 17.1795C18.4615 13.5754 16.1963 10.491 13.0151 9.27363ZM6.41025 5.1282C6.41025 3.14883 8.0206 1.53848 9.99998 1.53848C11.9794 1.53848 13.5897 3.14883 13.5897 5.1282C13.5897 7.10758 11.9794 8.71797 9.99998 8.71797C8.0206 8.71797 6.41025 7.10758 6.41025 5.1282ZM15.641 18.4615H4.35896C3.65205 18.4615 3.07693 17.8864 3.07693 17.1795C3.07693 13.362 6.18255 10.2564 10 10.2564C13.8175 10.2564 16.9231 13.362 16.9231 17.1795C16.9231 17.8864 16.3479 18.4615 15.641 18.4615Z" fill="white"/></svg></a>
                    </li><!-- alUserIcon end -->
                        ...
                        <div class="alShoppingList d-none">
                            <div class="widget widget-cart px-3 pt-2 pb-3" style="width: 20rem">
                                    ...
                                    <div class="simplebar-content" style="padding: 0px 16px 0px 0px;">
                                        ...
                                        <div class="widget-cart-item pb-2 border-bottom">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <a class="flex-shrink-0" href="#"><img src="images/icons.png" width="64" alt="Product"></a>
                                                <div class="ps-2">
                                ...
                                <div class="d-flex flex-wrap justify-content-between align-items-center pt-3">
                                    <div class="mr-2 pt-2"><span class="text-muted">Subtotal:</span><span class="text-accent ml-1">$265.<small>00</small></span></div>
                    ...
                    <li class="alMenuIcon">
                        <a href="#" class="alHamBurgerIcon">
                            <svg width="34" height="16" viewBox="0 0 34 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M34 1C34 1.55228 33.5523 2 33 2H1C0.447715 2 0 1.55228 0 1C0 0.447715 0.447716 0 1 0H33C33.5523 0 34 0.447715 34 1Z" fill="white"/><path class="alSmMenu" fill-rule="evenodd" clip-rule="evenodd" d="M27.8109 8C27.8109 8.55228 27.3632 9 26.8109 9H7.18921C6.63692 9 6.18921 8.55228 6.18921 8C6.18921 7.44772 6.63692 7 7.18921 7H26.8109C27.3632 7 27.8109 7.44772 27.8109 8Z" fill="white"/><path fill-rule="evenodd" clip-rule="evenodd" d="M34 15C34 15.5523 33.5523 16 33 16H1C0.447715 16 0 15.5523 0 15C0 14.4477 0.447716 14 1 14H33C33.5523 14 34 14.4477 34 15Z" fill="white"/></svg>
                        </a>
                    </li><!-- alMenuIcon end -->
