                    ...
                    <div class="col-lg-3 col-md-6 d-none d-md-block mobile-border">
                        <div class="sub-title">
                            ...
                            <div class="footer-contant">
                                ...
                                @if($client_preference_detail->show_qr_on_footer) <div class="al_QRcode" style="margin-bottom:10px;">&nbsp; &nbsp; {!! QrCode::size(60)->generate($client_preference_detail->ios_link??'#') !!}   &nbsp; &nbsp; &nbsp; &nbsp;   &nbsp; &nbsp;     {!! QrCode::size(60)->generate($client_preference_detail->android_app_link??'#') !!}<br></div> @endif
