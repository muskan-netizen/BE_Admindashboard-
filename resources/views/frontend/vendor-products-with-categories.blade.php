...
@section('content')
    ...
    <section class="regular slider">
                <div>
                    <img src="{{asset('frontend/template_six/spaimages/singleP.png')  }}" alt="">
                </div>
                <div><img src="{{asset('frontend/template_six/spaimages/Homebanner.jpg')  }}" alt=""></div>
        ...
        <!-- <section class="regular-nav slider">
                <div><img src="{{asset('frontend/template_six/spaimages/singleP.png')  }}" alt=""></div>
                <div><img src="{{asset('frontend/template_six/spaimages/Homebanner.jpg')  }}" alt=""></div>
                <div><img src="{{asset('frontend/template_six/spaimages/membershipBanner.png')  }}" alt=""></div>
                <div><img src="{{asset('frontend/template_six/spaimages/singleP.png')  }}" alt=""></div>
    ...
    <section class="section-b-space ratio_asos">
        ...
        <section class="moreSpasNearby py-5 mb-5">
        	<div class="container">
        		<div class="row">
        			<div class="col-md-12">
        				<div class="alSpaListHead text-center text-lg-left col-12 mb-5">
                    ...
                    <div class="Spasslider w-100" id="Spasslider">
                        <div>
                        	<div class="SpasRelatedItems mx-2">
                        		...
                        		<div class="SpasRelatedDetails p-3">
	                        		<p class="text-left m-0">Park Plaza Cardiff</p>
	                        		<a href="#">10 Excellent (2 reviews)</a>
	                        		<p class="alBodyText m-0 d-flex align-items-center"><span class="border-right pr-3 mr-3">Business Bay</span><span>3.9 miles away</span></p>
                        		</div>
                        	</div>
                        </div>
