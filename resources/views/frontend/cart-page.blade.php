                                ...
                                <div class="col-lg-6">
                                        ...
                                        <div class="col-7 text-right">
                                            @if ($product->coupon_amount_used > 0)
                                                <p class="total_amt m-0">{{ Session::get('currencySymbol') }}
                                                    {{ decimal_format($product->coupon_amount_used) }}</p>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        @if ($cart_details->vendorCnt > 1)
                                            ...
                                            <div class="col-7 text-right">
                                                <p class="total_amt m-0">{{ Session::get('currencySymbol') }}
                                                    {{ decimal_format($product->product_total_amount + $product->vendor->fixed_fee_amount) }}
                                                </p>
                                            </div>
                                        @endif
                                    </div>
                                        ...
                                        <div class="col-12 alFourSpecificInstructions mt-2">
                                            ...
                                            <div class="order-user-name">
                                                <p class="mb-0"><img class="blur-up lazyloaded"
                                                        data-src="http://local.myorder.com/assets/images/discount_icon.svg"
                                                        src="http://local.myorder.com/assets/images/discount_icon.svg">
                        ...
                        <div class="col-lg-12 mt-3 cart-price">
                            ...
                            @if ($cart_details->sub_total > 0)
                                <div class="row">
                                    ...
                                    <div class="col-6 text-right"><b>
                                            {{ Session::get('currencySymbol') }}{{ decimal_format($cart_details->sub_total) }}</b>
                                    </div>
                                </div>
                                <hr class="my-2">
                            @endif
                            @if ($cart_details->total_service_fee > 0 && $price_bifurcation != 1)
                                <div class="row">
                                    ...
                                    <div class="col-6 text-right"><b>
                                            {{ Session::get('currencySymbol') }}{{ decimal_format($cart_details->total_service_fee) }}</b>
                                    </div>
                                </div>
                                <hr class="my-2">
                            @endif
                            ...
                            @if ($total_fixed_fee_amount > 0 && $price_bifurcation != 1)
                                <div class="row">
                                    ...
                                    <div class="col-6 text-right">
                                        <b>{{ Session::get('currencySymbol') }}{{ decimal_format($total_fixed_fee_amount) }}</b>
                                    </div>
            ...
            --}}
                ...
                @else  --}}
                                    <div class="col-6 text-right"><b>{{ Session::get('currencySymbol') }}<span
                                                id="gross_amount">{{ decimal_format($cart_details->gross_amount) }}</b></span>
                            ...
                            @if ($cart_details->total_taxable_amount + $other_taxes > 0)
                                <div class="row">
                                    ...
                                    <div class="col-6 text-right"><b>{{ Session::get('currencySymbol') }}<span
                                                id="total_taxable_amount">{{ decimal_format($cart_details->total_taxable_amount + $other_taxes) }}</span></b>
                                    </div>
                                </div>
                                <hr class="my-2">
                            @endif
                            @if ($cart_details->total_subscription_discount > 0)
                                <div class="row">
                                    ...
                                    <div class="col-6 text-right"><b> - {{ Session::get('currencySymbol') }}<span
                                                id="total_subscription_discount">{{ decimal_format($cart_details->total_subscription_discount) }}<span></b>
                                    </div>
                                </div>
                                <hr class="my-2">
                            @endif
                            ...
                            @if ($cart_details->loyalty_amount > 0 && $price_bifurcation != 1)
                                <div class="row">
                                    ...
                                    <div class="col-6 text-right"><b> - {{ Session::get('currencySymbol') }}<span
                                                id="loyalty_amount">{{ decimal_format($cart_details->loyalty_amount) }}</span></b>
                                    </div>
                                </div>
                                <hr class="my-2">
                            @endif
                            @if ($cart_details->wallet_amount_used > 0)
                                <div class="row">
                                    ...
                                    <div class="col-6 text-right" id="wallet_amount_used"> -
                                        {{ Session::get('currencySymbol') }}{{ decimal_format($cart_details->wallet_amount_used + $other_taxes) }}
                                    </div>
                                        ...
                                        <div class="tip_radio_controls">
                                            @if ($cart_details->total_payable_amount > 0)
                                                <input type="radio" class="tip_radio" id="control_01"
                                                    name="select" value="{{ $cart_details->tip_5_percent }}"
                                                ...
                                                <input type="radio" class="tip_radio" id="control_02"
                                                    name="select" value="{{ $cart_details->tip_10_percent }}">
                                                ...
                                                <input type="radio" class="tip_radio" id="control_03"
                                                    name="select" value="{{ $cart_details->tip_15_percent }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 text-right">
                                    ...
                                    @else
                                        <p class="total_amt m-0" id="cart_total_payable_amount"
                                            data-cart_id="{{ $cart_details->id }}">
                                            {{ Session::get('currencySymbol') }}{{ decimal_format(decimal_format($cart_details->total_payable_amount) + decimal_format($other_taxes)) }}
                                        </p>
                        ...
                        @if (!(
                            ...
                            @if ($cart_details->is_long_term_service != 1 &&
                                ...
                                <label class="btn btn-solid" for="tasknow">{{__('Now')}}</label>
                                                ...
                                                <div class=" col-sm-10 p-0 pull-right datenow d-flex align-items-center justify-content-end text-right mr-1"
                                                    id="schedule_div"
                                                    style="{{ $cart_details->schedule_type == 'schedule' ? '' : 'display:none!important' }}">
