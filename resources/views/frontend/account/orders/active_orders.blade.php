    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="row no-gutters order_head">
                ...
                <div class="col-md-3 alOrderStatus">
                    <h4>{{ __(getNomenclatureName('Customer Name',true)) }}</h4>
                            ...
                            <ul class="product_list p-0 m-0 text-center">
                                ...
                                @if(@$product->order_product_status->order_status_option_id == 2 && $order->luxury_option_id == 4 && $vendor->order_status_option_id==2)
                                    @if(@$product->Routes[0] && $product->Routes[0]['dispatch_traking_url'] != '')
                                        <li>
                                            <a href="{{$product->Routes[0]['dispatch_traking_url']}}" target="_blank"><label class="rating-star single-track-order" style="width: auto;display: inline-block;">
                                                Track Order
                                            </label></a>
                                        </li>
                                    @endif
