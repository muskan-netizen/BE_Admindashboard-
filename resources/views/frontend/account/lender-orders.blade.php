                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <div class="row mt-2">
                                                                <div class="col-md-9 mb-3">
                                                                    ...
                                                                    @if (in_array($vendor->order_status_option_id, [4]))
                                                                        <button type="button" name="dropOff_complete_btn" class="btn btn-info btn-sm dropOff_complete_btn" data-order_vendor_status="6" data-order_vendor_id="{{$vendor->id}}">DropOff Complete</button>
                                                                    @endif
                                                                </div>
...
@section('script')
    ...
    <script>
        $(document).on('click', '.dropOff_complete_btn', function(){
